...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'month'                 => 'mês (string)',
        'name'                  => 'nome (string)',
        'password_confirmation' => 'confirmação da senha (password)',
        ...
        'year'                  => 'ano',
        'label'                 => 'Mini Descrição (string)',
        'price'                 => 'valor (decimal[10,2])',
        'price_promotional'     => 'valor promocional (decimal[10,2])',
        'birth'                 => 'data de nascimento (date)',
        'district'              => 'bairro (string)',
        'street'                => 'endereço (string)',
        'number'                => 'número (string)',
        'cpf'                   => 'cpf (string)',
        'client_user_id'        => 'Cliente (integer)',
        'status'                => 'Situação (boolean)',
        'type'                  => 'Tipo',
        'observation'           => 'Observação (string)',
        'user_id'               => 'Usuário (integer)',
        'salespeople_id'        => 'Vendedor (integer)',
        'segment_id'            => "Segmento (integer)",
        'registration'          => "Número de Registro (string)",
        'segments_ids'          => "Segmentos (array)",
        'answer_question_1'     => "Pergunta 1 (string)",
        'answer_essay'          => "Redação (string)",
        'use_api'               => "Escolha do Uso da API (boolean)",
        'terms'                 => "Termos de Uso (on[checkbox])",
    ],
];
