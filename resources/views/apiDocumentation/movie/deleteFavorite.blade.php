<div class="overflow-hidden content-section" id="content-get-characters">
    <h2 id="movie-deleteFavorite">Deletar Favorito</h2>
    <pre>
    <code class="bash">
    # Exemplo de Requisição em PHP
    $curl = curl_init();
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'http://teste-box/api/movie/deleteFavorite/{movie_id | Obrigatório}',
    ...
    <p>
        ...
        <code class="higlighted">{{ route("movie.deleteFavorite", ["movie_id"=>1]) }}</code>
    </p>
    <br>
    <pre>
    <code class="json">
...

    {
        "code": 30001,
        "status": "success",
        "message": "Filme retirado a lista de Favoritos!",
        "data": {
            "id": 1,
            ...
            "users": [
                {
                    ...
                    "status": 1,
                    "institution_id": 5,
                    "created_at": "2020-12-10T13:12:26.000000Z",
                    "updated_at": "2020-12-10T13:12:26.000000Z",
                    "deleted_at": null,
                    "pivot": {
                        "movie_id": 1,
                        "user_id": 12
    ...
    <table>
        ...
        <tr>
            <td>movie_id</td>
            <td>GET</td>
            <td>(Obrigatório) Esté parâmetro é passado na URL | ID do Filme</td>
        </tr>
        </tbody>
    </table>
</div>
